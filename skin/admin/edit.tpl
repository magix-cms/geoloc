...
{block name='article:header'}
    <h1 class="h2"><a href="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}" title="Afficher la liste des cartes">geoloc</a></h1>
{/block}
    ...
    <div class="panels row">
        <section class="panel col-xs-12 col-md-12">
            ...
            <div class="panel-body panel-body-form">
                ...
                {include file="form/address.tpl" controller="geoloc"}
            </div>
        </section>
    </div>
{/if}
...
{block name="foot" append}
    ...
    {capture name="scriptForm"}{strip}
        /{baseadmin}/min/?f={baseadmin}/template/js/vendor/typeahead.bundle.js,
        plugins/geoloc/js/admin.min.js
    {/strip}{/capture}
