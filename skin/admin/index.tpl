...
{block name='head:title'}geoloc{/block}
{block name='body:id'}geoloc{/block}
...
{if {employee_access type="view" class_name=$cClass} eq 1}
    ...
    <header class="panel-header panel-nav">
        <h2 class="panel-heading h5">Gestion de geoloc</h2>
    ...
    <div class="panel-body panel-body-form">
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane active" id="general">
                {include file="form/content.tpl" controller="geoloc"}
            </div>
            <div role="tabpanel" class="tab-pane" id="address">
                {include file="section/form/table-form-2.tpl" data=$address idcolumn='id_address' activation=false search=false sortable=true controller="geoloc" subcontroller="address"}
            </div>
    ...
    {include file="modal/delete.tpl" data_type='address' title={#modal_delete_title#|ucfirst} info_text=true delete_message={#delete_geoloc_message#}}
...
{block name="foot" append}
    ...
    {capture name="scriptForm"}{strip}
        /{baseadmin}/min/?f=plugins/geoloc/js/admin.min.js
    {/strip}{/capture}
